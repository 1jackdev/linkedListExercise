...
describe("pop", function() {
  ...
  it("removes node at end when length is 3", function() {
...
describe("setAt", function() {
  ...
  it("sets val at index when length is 1", function() {
...
describe("removeAt", function() {
  ...
  it("removes middle node from 3-item list", function() {
  ...
  it("removes tail node 3-item list", function() {
    let lst = new LinkedList(["a","b","c"]);
  ...
  it("throws error for invalid index", function() {
    let lst = new LinkedList(["a","b","c"]);
    expect(()=>lst.removeAt(3)).toThrowError(/Invalid index./);
    expect(lst.length).toBe(3);
    expect(lst.head.val).toBe("a");
    expect(lst.tail.val).toBe("c");
  });
...
describe("average", function() {
  ...
  it("returns only val for list of 1", function() {
    let lst = new LinkedList([5]);
    expect(lst.average()).toBe(5);
  });
